...
(function ($) {
    ...
    $.extend(Address.prototype, {
        ...
        **/
        value2html: function(value, element) {
            ...
            var html = $('<div>').text(value.address1).html() + ', ' + $('<div>').text(value.address2).html() + ', ' + $('<div>').text(value.city).html() + ', ' + $('<div>').text(value.state).html() + '  ' + $('<div>').text(value.zip).html();
            $(element).html(html); 
        },
    ...
    Address.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        tpl: '<div class="editable-address"><label><span>Address 1: </span><input type="text" name="address1" class="input-small"></label></div>'+
             '<div class="editable-address"><label><span>Address 2: </span><input type="text" name="addrerss2" class="input-small"></label></div>'+
