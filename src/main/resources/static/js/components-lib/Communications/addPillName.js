...
var AddPillName = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                "div",
                { id: "add-pill-name", className: "input-group" },
                React.createElement(
                    "span",
                ...
                this.state.showResults ? React.createElement(AddPillNameResults, { data: this.state.data, handleAddUser: this.handleAddUser.bind(this) }) : null
            )
        );
    },
...
var AddPillNameResults = React.createClass({
    displayName: "AddPillNameResults",
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                this.props.data.map((function (obj) {
                    return React.createElement(AddPillNameResultObj, { key: obj.id, data: obj, firstName: obj.firstName, lastName: obj.lastName, profession: obj.profession, handleAddUser: this.handleAddUser.bind(this, obj.id) });
                }).bind(this))
            )
        );
    }
...
var AddPillNameResultObj = React.createClass({
    displayName: "AddPillNameResultObj",
