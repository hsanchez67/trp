...
$(document).ready(function () {
    function formatGeneralResponse(data) {
        ...
        var markup = '<div class="clearfix">' + '<div class="col-sm-2">' + '<img class="img-circle" src="/api/remoteFiles/view/' + data.avatar + '" style="max-width: 60px" />' + '</div>' + '<div class="col-sm-10">' + '<div class="clearfix">' + '<div class="full-name">' + data.firstName + ' ' + data.lastName + '</div>' + '<div><i class="fa fa-star"></i> 9.2 </div>' + '</div>';
