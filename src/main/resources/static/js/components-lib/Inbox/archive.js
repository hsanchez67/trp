            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(ArchiveContent, { user: this.state.user, count: this.state.count }),
                        React.createElement(
                            'div',
                            { className: 'col-lg-4' },
...
ReactDOM.render(React.createElement(Archive, null), document.getElementById('content'));