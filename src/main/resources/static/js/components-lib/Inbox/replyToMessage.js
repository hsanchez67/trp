        ...
        $.ajax({
            ...
            success: (function (result) {
                ...
                if (!$.isEmptyObject(result)) {
                    ...
                    var html = '<p></p><p>' + this.state.profileData.firstName + ' ' + this.state.profileData.lastName + ' wrote on ' + this.state.communication.created[1] + '/' + this.state.communication.created[2] + '/' + this.state.communication.created[0] + ' ' + this.state.communication.created[3] + ':' + this.state.communication.created[4] + '</p>';
