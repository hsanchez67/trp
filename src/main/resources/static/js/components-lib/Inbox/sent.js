            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(SentContent, { user: this.state.user, count: this.state.count }),
                        React.createElement(
                            'div',
                            { className: 'col-lg-4' },
...
ReactDOM.render(React.createElement(Sent, null), document.getElementById('content'));