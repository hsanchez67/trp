...
$(document).ready(function () {
    ...
    function formatAjaxResponse(data) {
        ...
        var markup = '<div class="clearfix">' + '<div class="col-sm-2">' + '<img class="img-circle" src="/api/remoteFiles/view/' + data.avatar + '" style="max-width: 40px" />' + '</div>' + '<div class="col-sm-10">' + '<div class="clearfix">' + '<div>' + data.firstName + ' ' + data.lastName + '</div>' + '<div><i class="fa fa-star"></i> ' + data.score + '</div>' + '</div>';
