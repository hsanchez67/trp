            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(IntroductionContent, { user: this.state.user, communication: this.state.communication, toUser: this.state.toUser, subjectUser: this.state.subjectUser, profession: this.state.profession }),
                        React.createElement(
                            'div',
                            { className: 'col-lg-4' },
...
ReactDOM.render(React.createElement(IntroductionDraft, null), document.getElementById('content'));