    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                'span',
                null,
                React.createElement('canvas', { className: 'canvas-score-doughnut hidden', id: "text-" + this.props.count, height: '60', width: '60' }),
                React.createElement('canvas', { className: 'canvas-score-text', id: "canvas-" + this.props.count, height: '60', width: '60' })
            ),
            React.createElement(
                'span',
                { style: avatarSpan },
                React.createElement('img', { id: this.props.id, src: '/api/remoteFiles/view/' + this.props.avatar, style: avatarImage, className: 'img-circle' })
            )
        );
    }
});