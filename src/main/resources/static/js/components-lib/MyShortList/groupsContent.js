...
var GroupsContent = React.createClass({
    ...
    componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
        if ((nextProps.myGroup != this.props.myGroup || nextProps.user != this.props.user) && (!$.isEmptyObject(nextProps.myGroup) && !$.isEmptyObject(nextProps.user))) {
            ...
            var svg = d3.select("#group-tree").append("svg").attr("width", width).attr("height", height);
            ...
            node.append("svg:text").attr("class", "ini").attr("fill", function (d) {
                if (d.avatar != "default") {
                    return "transparent";
                } else {
                    return "gray";
                }
            }).attr("text-anchor", "middle").attr("y", 8).attr("width", 40).attr("height", 40).text(function (d) {
                return d.initials;
            });
    ...
    render: function render() {
        return React.createElement(
            'div',
            { className: 'tab-pane fade', id: 'my-group-content' },
            React.createElement(
                'div',
                { className: 'row' },
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: 'form-group text-left margin-top-10' },
                        React.createElement(
                            'div',
                            ...
                            React.createElement(
                                'select',
                                { className: 'form-control', id: 'loadGroup', ref: 'loadGroup', selected: this.props.groupName, style: selectResponsive100 },
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'div',
                            { className: 'ui-widget' },
                            React.createElement('input', { className: 'form-control', type: 'text', id: 'searchGroup' }),
                            React.createElement(
                                'button',
            ...
            React.createElement('div', { id: 'group-tree' }),
            React.createElement('div', { ref: 'my-modal-groups', id: 'my-modal-groups' })
        );
    }
});