...
var IntroductionContent = React.createClass({
    ...
    reloadPage: function() {
        window.location.href = '/introductionDraft/' +  this.state.communication.id;
    },
    addAttachments: function (object) {
    ...
    removeAttachments: function() {
        console.log('IntroductionContentDraft:removeAttachments');
        this.setState({
            attachments: []
        });
    },
    ...
    componentWillMount: function () {
        console.log("IntroductionContentDraft:componentWillMount:");
        this.prepareComponentState(this.props);
    },
    componentWillReceiveProps: function (nextProps) {
        console.log("IntroductionContentDraft:componentWillReceiveProps:");
        this.prepareComponentState(nextProps);
    },
    prepareComponentState: function(props) {
        console.log("IntroductionContentDraft:prepareComponentState:");
        console.log(props);
        ...
        if (!$.isEmptyObject(props.communication) && $.isEmptyObject(this.state.communication)) {
            console.log("IntroductionDraftContent:prepareComponentState:communication");
            this.setState({
    ...
    loadProfession: function(data) {
        $('#contact1EditProfession').text(data);
    },
    loadToProfile: function(data) {
        var initials = this.getInitials(data.firstName+" "+data.lastName);
        this.setState({
            p2: data,
            contactid2: data.id,
    ...
    loadCommunication: function(comm) {
        ...
        return (
            <div className="col-lg-8">
                <div name="introductionForm">
                    <div className="form-group">
                        <h2 className="page-header text-left">Make an Introduction</h2>
                        ...
                        <div className="row" id="shortList-content">
                                            ...
                                            <div className="col-lg-2 col-md-4 col-sm-4 col-xs-2">
                                                <ol>
                                                    <li id="avatar1li" className="placeholder">
                                                        <img id="avatar1" ref="avatar1" src="../images/120px-blank.png" className="contact-img img-circle" />
                                                    </li>
                                                </ol>
                                            </div>
                                            ...
                                            <div className="col-lg-2 col-md-4 col-sm-4 col-xs-2">
                                                <ol>
                                                    <li id="avatar2li" className="placeholder">
                                                        <img id="avatar2" ref="avatar2" src="../images/120px-blank.png" className="contact-img img-circle" />
                                                    </li>
                                                </ol>
                                            </div>
                            ...
                            <ReasonNote onReasonChange={this.handleReasonChange} onReasonSwitchChange={this.handleReasonSwitchChange} reason={this.state.reason} reasonSwitch={this.state.reasonSwitch} />
                ...
                <ConfirmationModal title={'Your message has been sent.'} type={'Introduction'} username1={this.state.confirmationUsername1} username2={this.state.confirmationUsername2} initials1={this.state.confirmationInitials1} initials2={this.state.confirmationInitials2} handleHideModal={this.handleHideConfirmationModal} />
    ...
    handleHideConfirmationModal: function() {
        var data = {
