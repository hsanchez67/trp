var NetworkContent = React.createClass({
    ...
    componentWillReceiveProps: function(nextProps) {
        if (!$.isEmptyObject(nextProps.myNetwork) && !$.isEmptyObject(nextProps.user) && $('#network-tree').html().length == 0) {
         /*   this.setState({
            ...
            var svg = d3.select("#network-tree").append("svg")
                .attr("width", width)
                .attr("height", height);
    ...
    render: function () {
        return (
            <div className="tab-pane fade" id="my-network-content">
                <div className="navbar-form">
                    <div className="ui-widget">
                        <input className="form-control" type="text" id="searchNetwork" />
                ...
                <div ref="my-modal" id="my-modal"></div>
            </div>
        );
    },
});
