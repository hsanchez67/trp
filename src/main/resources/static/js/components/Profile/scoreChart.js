var ScoreChart = React.createClass({
        ...
        if (id != null) {
            ...
            $.get(source, function(result) {
                ...
                if (this.isMounted()) {
                    ...
                    var data2 = [
                        {value : data.score, color : scoreColor, label : "Score"},
                        {value : 10-data.score, color : '#003F5D', label : "Missing"}
                    ];
    ...
    render: function() {
        return (
            <span>
                <canvas className="canvas-score-doughnut"  id="text-profile-panel" height="120" width="120"></canvas>
                <canvas className="canvas-score-text" id="canvas-profile-panel"  height="120" width="120"></canvas>
            </span>
        );
    }
});