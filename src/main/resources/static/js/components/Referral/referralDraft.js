                ...
                <div className="container">
                    <div id="main">
                        ...
                        <div className="row" id="introduction-content">
                            <ReferralContent  subjectUser={this.state.subjectUser} profession={this.state.profession} user={this.state.user}  communication={this.state.communication} toUser={this.state.toUser} />
