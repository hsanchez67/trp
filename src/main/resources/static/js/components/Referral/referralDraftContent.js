...
var ReasonNote = React.createClass({
    ...
    render() {
        ...
        return (
            <div id="reason-note" className="col-lg-12 col-sm-12">
                <div className="panel panel-default">
                    <div  className="panel-heading">
        ...
        return (
            <div className="col-lg-8">
                <div name="introductionForm">
                    <div className="form-group">
                        <h2 className="page-header text-left">Send a Referral</h2>
                ...
                <ConfirmationModal title={'Your message has been sent.'} type={'Referral'} username1={this.state.confirmationUsername1} username2={this.state.confirmationUsername2} initials1={this.state.confirmationInitials1} initials2={this.state.confirmationInitials2} handleHideModal={this.handleHideConfirmationModal} />
