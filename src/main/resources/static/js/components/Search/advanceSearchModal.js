    ...
    render:function() {
        ...
        return (
            <div className={this.props.count%2===0 ? 'row resultInstant' : 'row resultInstantGrey'}>
                <div className="col-md-2 text-center vert-align">
                    <ul className="source">
                ...
                <div className="col-md-4 text-left">
                    ...
                    <a className="btn btn-primary btn-xs" onClick={this.props.onClick} role="button">{this.props.action} {this.props.firstName}</a>
                </div>
                <div className="col-md-4 text-left">
                    {leadParagraph}
                </div>
...
var AdvanceSearchModal = React.createClass({
    ...
    doSearch2: function(queryName, queryProfession, queryLocation, queryNetwork, sort, page) {
    ...
    render(){
        ...
        return (
        <div id="advance-search" className="col-lg-12 col-sm-12 collapse">
            <section className="panel panel-default" id="search-panel">
                <div className="panel-heading"><h3 className="panel-title text-left">Advanced Search</h3></div>
                        ...
                        <div className="col-lg-12">
                            ...
                            <div className="form-group text-left">
                                ...
                                <div className="input-group">
                                    ...
                                    <select id="searchProfessionSelect" className="form-control js-example-placeholder-single" className="searchProfession" ref="searchProfession" style={selectResponsive2}>
                            ...
                            <div className="form-group text-left">
                                ...
                                <div className="input-group">
                                    ...
                                    <input type="text" className="form-control" id="searchLocation" ref="searchLocation" placeholder="Location"  />
                                </div>
                            </div>
                            <div className="form-group text-left">
                            ...
                            <button type="button" className="btn btn-sm btn-default btn-primary" onClick={this.doSearch} >
                                <i id="send-intro-icon" className="fa fa-search "></i>&nbsp;
                                Search
                            </button>&nbsp;
                            <button type="button" className="btn btn-sm btn-default" onClick={this.doClear}>Clear</button>&nbsp;
                            <button type="button" className="btn btn-sm btn-default" onClick={this.doClose} data-dismiss="modal">Close</button>
                ...
                <div className="row">
                    <div className="col-md-12">
                        <SearchResults data={this.state.filteredConsumers} action={this.props.action} handleClick={this.props.handleClick} />
                    </div>
                </div>
            </section>
        </div>
